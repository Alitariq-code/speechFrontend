...
async function compareAudio() {
  ...
  console.log('sending request: Request for Google API');
  try {
    // Make the AJAX request using the Fetch API
    const response = await fetch('http://15.222.30.141:5000/process_audio', {
      method: 'POST',
      headers: {
...
async function vkosApi() {
  ...
  console.log('sending request: Request for vkos');
  try {
    // Make the AJAX request using the Fetch API
    const response = await fetch('http://15.222.30.141:5001/process_audio', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
async function handleApi() {
  try {
    // Call other asynchronous functions here using await
    const result1 = await compareAudio();
    const result2 = await vkosApi();
